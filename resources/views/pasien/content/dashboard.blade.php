...
@section('meta')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            var SITEURL = "/pasien/jadwal-konseling";
        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <input type="hidden" value="@if ($count_konseling > 0) Sesi Konseling {{ $konseling->kategori->nama }} @endif" id="title">
                    <input type="hidden" value="{{ $date }}" id="start">
                    <div id='calendar'></div>
                </div>
            </div>
        </div>
