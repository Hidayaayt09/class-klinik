                        ...
                        <form class="kirim_pesan" style="display: none">
                            <div class="type_msg">
                                <div class="input_msg_write">
                                    ...
                                    <input type="hidden" name="sender" id="sender" value="{{ Auth::guard('admin')->user()->admin_id }}">
...
@section('scripts')
    <script type="text/javascript">
        ...
        function chatRealtime() {
            var id = $("#receiver").val();
            $.ajax({
                url: '/admin/sesi-online/message/'+id,
                method: 'GET',
                success:function(response){
                    // location.reload();
                    $(".isi-chat").html(response.success);
    ...
    <script>
        ...
        function sendTokenToServer(fcm_token) {
            ...
            const admin_id = "{{Auth::guard('admin')->user()->admin_id}}";
            axios.post('api/save-token-admin', {
                fcm_token, admin_id
            }).then(res => {
                console.log(res);
            });
