<x-guest-layout>
    <x-jet-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="mt-4">
                <x-jet-label for="no_wa" value="{{ __('No Whatsapp') }}" />
                <x-jet-input id="no_wa" class="block mt-1 w-full" type="number" name="no_wa" :value="old('no_wa')" required autofocus autocomplete="no_wa" />
            </div>
